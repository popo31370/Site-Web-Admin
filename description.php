...
if ($response) {
    ...
    $response= $response['_embedded']['descriptionList'];
...
<script type="text/javascript" src="search_script.js"></script>
    ...
    <div class="container">
    <br/>
    <h2><?php echo $translations['listDesc']; ?></h2><br/>
    <div class="container">
    <div class="row">
        <div class="col-md-12">
...
?>
<a href="add_desc.php" class="add-medication-link">
    <span class="material-symbols-outlined">add_circle</span>
    <span class="link-text"><?php echo $translations['addDesc']; ?></span>
</a>
<br/>
<table class="table table-striped">
    <thead class="table-lign">
        <tr>
            ...
            <th><?php echo $translations['descFR']; ?></th>
            <th><?php echo $translations['descEn']; ?></th>
    ...
    <tbody>
        <?php foreach ($currentPage as $mydata): ?>
            <tr>
                ...
                <td><?= $mydata['nomEn']; ?></td>
                <td>
                <a href="supprimer_desc.php?id=<?= $mydata['id']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');">
                    <span class="material-symbols-outlined delete-icon">delete</span>
                </a>                
                <a href="editer_desc.php?id=<?= $mydata['id']; ?>"><span class="material-symbols-outlined">edit</span></a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
